...
nspan_panels = 15
nchord_panels = 3
cs_y_les = np.linspace(0, 3.30/10, nspan_panels)
...
example_airplane = ps.geometry.Airplane(
    ...
    wings=[
        ...
        ps.geometry.Wing(
            ...
            z_le=0.0,
            symmetric=True,
            num_chordwise_panels=nchord_panels,
...
wing_cs_movements = []
pitchcounter = 1
dpitch = 45/len(example_airplane.wings[0].wing_cross_sections[1:])
...
for wing_cs in example_airplane.wings[0].wing_cross_sections[1:] :
    wing_cs_movements.append(
        ps.movement.WingCrossSectionMovement(
            ...
            # pitching_amplitude=dpitch*pitchcounter,
            # # pitching_amplitude=0,
            # pitching_period=1,
            # pitching_spacing="sine",
            # # sweeping_amplitude=45,
            # # sweeping_period=1,
            # # sweeping_spacing="sine"
